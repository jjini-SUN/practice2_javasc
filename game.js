...
class Bird {
    ...
    //화면에 그리기
    draw() {
        ctx.drawImage(birdImg, 450, 80, 130, 100, this.x, this.y, this.width, this.height)  //히트박스
    }
}
...
function perform() {
    animation = requestAnimationFrame(perform)  //모니터의
...
document.addEventListener("keydown", (e)=>{
    // 스페이스가 눌렸는지 검사한다
    // 고양이의 위치가 기본위치일 때만 jump_flag를 true 시킨다
    if(e.code === 'Space'){
